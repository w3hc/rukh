...
export interface RukhGovernanceTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DOMAIN_SEPARATOR"
...
export interface RukhGovernanceToken extends BaseContract {
  connect(runner?: ContractRunner | null): RukhGovernanceToken;
  waitForDeployment(): Promise<this>;

  interface: RukhGovernanceTokenInterface;
