...
export interface RukhGovernorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export interface RukhGovernor extends BaseContract {
  connect(runner?: ContractRunner | null): RukhGovernor;
  waitForDeployment(): Promise<this>;

  interface: RukhGovernorInterface;
