...
export interface OufGovernanceTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DOMAIN_SEPARATOR"
...
export interface OufGovernanceToken extends BaseContract {
  connect(runner?: ContractRunner | null): OufGovernanceToken;
  waitForDeployment(): Promise<this>;

  interface: OufGovernanceTokenInterface;
